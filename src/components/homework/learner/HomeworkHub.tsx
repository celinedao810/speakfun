        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-emerald-600 mt-0.5">
              ...
              {' '}· Vocab {submission.ex1Score.toFixed(1)} + Sentences {submission.ex2Score.toFixed(1)} + Reading {(submission.ex3aScore + submission.ex3bScore).toFixed(1)}
            </p>
          </div>
  ...
  return (
    <div className="bg-card rounded-xl border border-border p-5">
      <div className="flex items-center gap-2 mb-3">
        ...
        {hw.isReviewSession && (
          <span className="text-xs px-2 py-0.5 bg-amber-100 text-amber-700 rounded-full font-medium ml-auto">
            Review Day
          </span>
        )}
      </div>
        ...
        <div>
          ...
          <div className="flex items-center gap-3 mb-3">
            {[
              ...
              { label: 'Reading', done: submission?.ex3Completed },
            ].map(({ label, done }) => (
